...
/**
 * Next lines of code used to build http interceptors
 */
...
// axios
//   .post<User>("/user", { foo: "bar" })
//   .then(handleUserResponse)
//   .catch(handleError);

// axios
//   .post<User>("/user", { foo: "bar" }, { headers: { "X-FOO": "bar" } })
//   .then(handleUserResponse)
//   .catch(handleError);

// axios
//   .put<User>("/user", { foo: "bar" })
//   .then(handleUserResponse)
//   .catch(handleError);

// axios
//   .patch<User>("/user", { foo: "bar" })
//   .then(handleUserResponse)
//   .catch(handleError);
...
// axios
//   .post<User, string>("/user", { foo: "bar" })
//   .then(handleStringResponse)
//   .catch(handleError);

// axios
//   .post<User, string>("/user", { foo: "bar" }, { headers: { "X-FOO": "bar" } })
//   .then(handleStringResponse)
//   .catch(handleError);

// axios
//   .put<User, string>("/user", { foo: "bar" })
//   .then(handleStringResponse)
//   .catch(handleError);

// axios
//   .patch<User, string>("/user", { foo: "bar" })
//   .then(handleStringResponse)
//   .catch(handleError);
